...
func (s *SQLiteStore) GetGlobalTimeline(ctx context.Context, limit int, offset int) ([]TimelineItem, error) {
	// SQLite queries for literal strings sometimes need quotes or casting.
	query := `
		SELECT 
